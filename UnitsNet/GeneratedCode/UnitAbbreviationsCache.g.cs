    ...
    public partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(VolumeUnit), (int)VolumeUnit.UsLegalCup, new string[]{"cup", "cups"}),
                ("cs-CZ", typeof(VolumeUnit), (int)VolumeUnit.UsLegalCup, new string[]{"šálek", "šálku", "šálků"}),
                ...
                ("cs-CZ", typeof(VolumeUnit), (int)VolumeUnit.UsTablespoon, new string[]{"lžíce", "lžička", "lžičky", "lžičku"}),
